...
for generic proving by formally describing what it means for a semantics
to be able to simulate another one (Section~\ref{section:simulation}),
or for two semantics to be fusable (Section~\ref{section:fusion}).
...
Semantics are defined in Figure~\ref{figure:lamsem} in terms of a choice of values \AB{$\mathcal{V}$} and
