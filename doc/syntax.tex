...
work and boilerplate, we apply the methodology of data-genericity to
...
\subsection{A Mechanized Typed Variant of Altenkirch and Reus' Calculus}\label{section:mech-reus}
...
\AD{List} \AB{I} (\AB{I} is a parameter of the construction meant to
represent the set of sorts for our language) and whose morphisms are
