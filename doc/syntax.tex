...
and ACMM's implementation of a
...
\todo{Expand}
Generic notion of contexts corresponding to a syntax (cite Zipper, jokers),
and contextual closure of relations (e.g. reduction relation) together with
lemmas guaranteeing stability under ren, sub, etc. provided the base relation
is.

\todo{Expand}
Generic Typing Framework for raw syntaxes
