...
After implementing \AF{⟦\_⟧}, which acts on the objects of $\Set{}^J$, we can
...
\AD{List} indices, we recover a meaning function producing an endofunctor on \AB{I} \AF{─Scoped}.
...
Because for any \AR{VarLike} \AB{𝓥}, we can define \AF{fresh^{r}} of
