...
for environments and \AIC{s} the function lifting an existing de Bruijn variable
...
are outside the scope of this paper; describing them in detail would be a
distraction.
...
This means that the end user can seamlessly write pattern-matching programs on
...
\item{\ARF{alg}} We should have an algebra turning
      ...
      by the \AF{Kripke} typed defined below) into computations
\end{itemize}
...
variables no matter what their \AD{Mode} is. In constrast, the generated
