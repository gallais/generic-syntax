...
\AB{\rho_1}, \AB{\rho_2} and \AB{\rho_3} are related by \AB{𝓡^E} and we
are given a thinning \AB{\sigma} from \Theta to \Omega then \AB{\rho_1},
the thinned \AB{\rho_2} and the thinned \AB{\rho_3} should still be related.
...
The case of the alegbra follows a similar idea albeit 
