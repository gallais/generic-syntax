...
\caption{Type of Well Typed and Scope Families}
\end{figure}
...
scope when defining such families. We give two examples:
...
The inductive family \AD{Var} corresponds to well scoped and well typed
...
The \AD{Type} \AF{─Scoped} family \AD{Lam} is the well typed variant of Altenkirch
...
\end{minipage}
\begin{minipage}{0.35\textwidth}
  \ExecuteMetaData[Generic/Examples/UntypedLC.tex]{LC}
\end{minipage}

\begin{minipage}{0.30\textwidth}
  \ExecuteMetaData[Generic/Examples/UntypedLC.tex]{var}
\end{minipage}
\begin{minipage}{0.30\textwidth}
  \ExecuteMetaData[Generic/Examples/UntypedLC.tex]{app}
\end{minipage}\hspace{2em}
\begin{minipage}{0.30\textwidth}
  \ExecuteMetaData[Generic/Examples/UntypedLC.tex]{lam}
\end{minipage}
...
\begin{figure}[h]
{\center \ExecuteMetaData[Generic/Semantics.tex]{sembody}}
...
\begin{figure}[h]
\begin{minipage}{0.45\textwidth}
  \ExecuteMetaData[Generic/Examples/ElaborationLet.tex]{ntimes}
\end{minipage}\hspace{2em}
\begin{minipage}{0.45\textwidth}
...
Following Bob Atkey, we can consider type checking and inference
as the semantics of bi-directional (thus bi-sorted) language.
The computation type here correspond to either a checking function
or a returned \AD{Type} if the expression considered is \AIC{Infer}.

\todo{more}

\begin{figure}[h]
\ExecuteMetaData[Generic/Examples/ElaborationType.tex]{bidirectional}
\ExecuteMetaData[Generic/Examples/ElaborationType.tex]{typemode}
\ExecuteMetaData[Generic/Examples/ElaborationType.tex]{typecheck}
...
\begin{minipage}{0.55\textwidth}
  ...
  \ExecuteMetaData[Generic/Cofinite.tex]{clistpat}
\end{minipage}\hspace{2em}
\begin{minipage}{0.35\textwidth}
