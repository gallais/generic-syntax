...
to the definition of the printer. To print a variable, we are handed
the \AR{Name} associated to it by the environment and \AF{return} it
immediately.
...
Putting this all together, we get the \AF{Printing} semantics shown
in Figure~\ref{fig:printing}.
