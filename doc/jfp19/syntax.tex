...
convention (see e.g.~\cite{martin1982constructive}) of mentioning only
...
show, equipped with these new notions we can define an abstract concept
...
First of all, values \AB{𝓥} should be \AF{Thinnable} so that \semfun{} may push the
...
We will then see that much of the standard traversals produced by the
...
This set of constraints is enough to prove a fundamental lemma of \AR{Fus}ion
...
stable under substitution), accommodating terms with suspended substitutions is
