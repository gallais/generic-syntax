...
interactive loop. The other direction takes strings as inputs and attempts to
...
and the third step consist in type checking terms in the well scoped syntax.
...
\ExecuteMetaData[Generic/Scopecheck.tex]{scopechecktype}
