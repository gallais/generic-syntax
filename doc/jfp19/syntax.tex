...
\item In the course of proving the correctness lemma, one needs to
  ...
  stated and proved separately (e.g, as observed by
  \citet{benton2012strongly}).
\end{enumerate}
...
are \AR{VarLike}. Hence, we can then implement \AF{reify} as in Figure~\ref{fig:genericreify}:
