...
projecting out the (in this case, unique) \AF{lookup} field, as
{\AF{lookup}~\AB{\(\rho\)}~=~\AB{r}}. Examples of definition in this
...
(or else Agda's default \AgdaKeyword{record} syntax), or in copattern
