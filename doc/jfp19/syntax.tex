...
to an exponential blow-up in code size. Compilers passes typically try
...
expressions used exactly one time can be inlined to open up opportunities
...
an example demonstrating that this is a rather subtle matter.

\begin{figure}[h]
  \ExecuteMetaData[Generic/Semantics/Elaboration/LetCounter.tex]{}
\end{figure}
