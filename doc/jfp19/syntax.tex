...
can however take care of the name generation and the traversal generically.

Reusing the notions of \AF{Name} introduced in Section~\ref{section:printing},
we can describe what it means for a substructure to have already been printed.
