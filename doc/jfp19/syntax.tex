...
To introduce the basic ideas that this paper bulids on, we start with
...
for wriring generic programs in Section~\ref{section:catalogue}:
...
To improve on this situtation, previous authors have proposed to use
